	...
	time_t *__time1;
{
	...
	tm1 = tma.tm_year*32227200L+tma.tm_yday*86400L+tma.tm_hour*3600+
	      tma.tm_min*60+tma.tm_sec;
	tm2 = tmb.tm_year*32227200L+tmb.tm_yday*86400L+tmb.tm_hour*3600+
