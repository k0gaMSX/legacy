...
_PROTOTYPE(void expr1, (struct value *valp));
_PROTOTYPE(void expr2, (struct value *valp));
_PROTOTYPE(void expr3, (struct value *valp));
_PROTOTYPE(void expr4, (struct value *valp));
_PROTOTYPE(void expr5, (struct value *valp));
_PROTOTYPE(void expr6, (struct value *valp));
_PROTOTYPE(void expr7, (struct value *valp));
_PROTOTYPE(int nullz, (struct value *valp));
_PROTOTYPE(int numvalue, (struct value *valp));
_PROTOTYPE(char *strvalue, (struct value *valp));
_PROTOTYPE(char *strsave, (char *string));
_PROTOTYPE(void invalid, (char *err));
_PROTOTYPE(void docolon, (struct value *match, struct value *pattern));
_PROTOTYPE(void rcomp, (char *regexp));
_PROTOTYPE(void rmatch, (char *str));
_PROTOTYPE(char *rtry, (char *str, unsigned char **pcp));
_PROTOTYPE(char *tryone, (char *str, unsigned char **pcp));
