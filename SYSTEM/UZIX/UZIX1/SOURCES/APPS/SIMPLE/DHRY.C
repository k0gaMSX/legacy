...
int main()
{
  printf("\"DHRYSTONE\" Benchmark Program vr. %s\n\n", Version);
  printf("Please wait for %d seconds while benchmarking your system...\n", SECONDS);
  Proc0();
  return(0);
}
...
CapitalLetter CharPar2;
{
  ...
  CharLoc1 = CharPar2;
  CharLoc2 = CharLoc1;
  /* note: the original code was CharLoc1=CharPar1;if(CharLoc2!=CharPar1).
  	   but HTC generate wrong code for it, and dhry.com hangs. That's
  	   why the swap of variables.
  */
  if (CharLoc2 != CharPar1)
	return(Ident1);
  else
	return(Ident2);
}
